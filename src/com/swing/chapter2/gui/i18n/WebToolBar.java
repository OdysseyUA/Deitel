...
import com.swing.chapter2.gui.actions.MyAbstractAction;
...
public class WebToolBar extends JToolBar implements HyperlinkListener {
	...
	public WebToolBar(WebBrowserPane browser, Locale locale) {
		...
		ResourceBundle resources = ResourceBundle.getBundle("StringsAndLabels",
				locale);
		...
		backAction.setSmallIcon(new ImageIcon(getClass().getResource(
				"images/back.gif")));
		...
		forwardAction
				.setShortDescription(resources.getString("forwardToolTip"));
