...
public class ActionSample extends JFrame {
	...
	public ActionSample() {
		...
		//		.getResource("images/Help24.gif")));
		
		sampleAction.putValue(Action.SMALL_ICON, new ImageIcon(System
				.getProperty("user.dir") + "\\images\\Help24.gif"));
		...
		sampleAction.putValue(Action.SMALL_ICON, new ImageIcon(System
				.getProperty("user.dir") + "\\images\\EXIT.gif"));
