...
// Swing components.
package com.swing.chapter2.gui.actions;
	...
	public ActionSample2() {
		...
		sampleAction = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				action.createDialog(ActionSample2.this, "sampleAction")
						.setVisible(true);
		...
		// set Action Icon
		sampleAction.putValue(Action.SMALL_ICON, new ImageIcon(getClass()
		...
		exitAction = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				// description
				AccessibleContext exitContext = exit.getAccessibleContext();
				...
				// create and display dialog box
				exit.createDialog(ActionSample2.this, "exitAction").setVisible(
						true);
		...
		// set Action icon
		exitAction.putValue(Action.SMALL_ICON, new ImageIcon(getClass()
		...
		// description
		AccessibleContext toolContext = toolBar.getAccessibleContext();
